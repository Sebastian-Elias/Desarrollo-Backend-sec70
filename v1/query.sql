...
(1, 1, 1, 'Misión', 'Nuestra misión es proporcionar soluciones digitales innovadoras y personalizadas que impulsen el crecimiento y la transformación de nuestros clientes.', true),
(2, 1, 2, 'Visión', 'Nuestra visión es convertirnos en líderes destacados en la transformación digital, reconocidos por nuestra excelencia en el servicio al cliente, nuestra capacidad para anticipar y adoptar las tendencias tecnológicas emergentes, y nuestro impacto positivo en la sociedad y el medio ambiente. Nos vemos como pioneros que impulsan el cambio positivo, elevando los estándares de la industria hacia un futuro sostenible y conectado.', true);